...
return
    [
        ...
        GatewayGetHighestScoreBySerieForUserAction::class => function (ContainerInterface $c) {
            return new GatewayGetHighestScoreBySerieForUserAction($c->get('guzzle.client.geoquizz'));
        },
