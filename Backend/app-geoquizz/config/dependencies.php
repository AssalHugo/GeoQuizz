...
return [
    ...
    GameServiceInterface::class => function (ContainerInterface $container) {
        return new GameService($container->get(GameRepositoryInterface::class), $container->get(SerieDirectusInterface::class), $container->get(UserServiceInterface::class), $container->get('rabbitmq'));
    },
